namespace SparkEngine.Components
{
    ...
    public struct WrappingScreenGrid : IComponent
    {
        ...
        public void SetWrappedDimensions(int width, int height)
        {
            ...
            if (XHead == 0)
            {
                XOffsetEast = Width % width;
            }
            if (YHead == 0)
            {
                YOffsetSouth = Height / height;
            }
        }
